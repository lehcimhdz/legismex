...
class CoahuilaIniciativa(BaseModel):
    ...
    descripcion: str = Field(description="Descripción o título de la iniciativa")
    legislatura: str = Field(description="Legislatura correspondiente, e.g. 'LXIII'")
    anio_legislativo: str = Field(description="Año legislativo, e.g. '2026'")
    url_pdf: Optional[str] = Field(None, description="Enlace al documento base en formato PDF")
    url_abierto: Optional[str] = Field(None, description="Enlace al documento base en formato abierto (DOCX)")
